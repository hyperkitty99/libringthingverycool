...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Screen Shake', "Value 1: Intensity\nValue 2: Type 1 to turn on."],
		['Change Character', "Value 1: Character to change (Dad, BF)\nValue 2: New character's name"],
		['Change Scroll Speed', "Value 1: Scroll Speed Multiplier (1 is default)\nValue 2: Time it takes to change fully in seconds."],
		['Set Camera Speed', "Value 1: The Camera speed.\nValue 2: Time it takes to change fully in seconds."],
	...
	**/
	...
	override function create()
	{
		...
		for (i in 0...tipTextArray.length) {
			...
			tipText.y += i * 12;
			tipText.setFormat(Paths.font("DIN2014Bold.ttf"), 14, FlxColor.WHITE, LEFT/*, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK*/);
	...
	function loadSong():Void
	{
		...
		var file:Dynamic = Paths.music('Voices');
		vocals = new FlxSound();
	...
	function generateSong() {
		FlxG.sound.playMusic(Paths.music('Inst'), 0.6/*, false*/);
	...
	function updateGrid():Void
	{
		...
		for (i in _song.notes[curSec].sectionNotes)
		{
			...
			if(i[3] != null && note.noteType != null && note.noteType.length > 0) {
				...
				daText.setFormat(Paths.font("DIN2014Bold.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
				daText.xAdd = -32;
				daText.yAdd = 6;
				daText.borderSize = 1;
		...
		for (i in _song.events)
		{
			if(endThing > i[0] && i[0] >= startThing)
			{
				...
				daText.setFormat(Paths.font("DIN2014Bold.ttf"), 12, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
				daText.xAdd = -410;
				daText.borderSize = 1;
